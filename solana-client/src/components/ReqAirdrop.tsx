...
export const RequestAirdrop: FC = () => {
  ...
  const onAirdropClickHandler = useCallback(async () => {
    if (!publicKey) {
...
signature = await connection.requestAirdrop(publicKey, 2 * LAMPORTS_PER_SOL);
    ...
    //   console.log(LAMPORTS_PER_SOL, " LAMPORTS_PER_SOL");
      ...
      const temp = await getUserSOLBalance(publicKey, connection);
      console.log(temp, " user sol balance");
